...
export const serFoot =
  'Contact Solid Building Aspect Ltd today to discuss your construction needs. Let our expertise, experience, and dedication transform your vision into reality. Trust us, the leading subcontractor, to deliver solid construction services that exceed your expectations.';
...
export const servises = [
  ...
  {
    image: facade,
    header: 'Facade Solutions:',
    text: "Facade Solutions: We specialize in providing comprehensive services for building facades, offering innovative designs and solutions to enhance structural aesthetics and weather protection. From restoration to new installations, our team delivers excellence in facade services tailored to meet every project's unique requirements.",
  },
  // {
  //   image: paint,
